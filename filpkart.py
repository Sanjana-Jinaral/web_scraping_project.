...
if _name_ == '_main_':
    ...
    # The webpage URL
    jls_extract_var = "https://www.flipkart.com/search?q=gaming%20laptop%20under%2050000&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=off&as=off"
    URL = jls_extract_var
